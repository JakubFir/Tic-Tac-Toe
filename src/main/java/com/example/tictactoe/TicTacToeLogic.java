...
public class TicTacToeLogic {
    ...
    private char currentMove(){
        if(xTurn){
            ...
            checkIfSomeOneWin(ticTacToeData.getWinningMoves(),ticTacToeData.getMovesOfXPlayer());
            return 'X';
            ...
            checkIfSomeOneWin(ticTacToeData.getWinningMoves(),ticTacToeData.getMovesOfOPlayer());
            return 'O';
        }
        return move;
    }
    ...
    public boolean checkIfSomeOneWin(List<List> winningMoves, List<Integer> playerMoves){
